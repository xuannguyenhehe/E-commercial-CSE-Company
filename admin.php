      ...
      <table class="table table-striped" id="myTable">
        ...
        <tbody>
          <tr>
            ...
            <th scope="row">1</th>
            <td>xuannguyenhehe</td>
            <td>123456789</td>
            <td>Phạm Nguyễn Xuân Nguyên</td>
            <td>0777525661</td>
            <td>nickpham2808@gmail.com</td>
            <td>STAFF</td>
            <td>
          ...
          <tr>
            ...
            <td>thuphuong</td>
            <td>123456789</td>
            <td>Nguyễn Ngọc Thu Phương</td>
            <td>0123456789</td>
            <td>thuphuong@gmail.com</td>
            <td>STAFF</td>
            <td>
              <button class="btn btn-warning">Change</button>
              <button class="btn btn-danger">Delete</button>
